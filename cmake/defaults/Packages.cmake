...
if (PXR_BUILD_IMAGING)
    ...
    find_library(LIBZ "z")
    set(OPENSUBDIV_LIBRARIES ${OPENSUBDIV_LIBRARIES} ${LIBZ})
    # --Ptex
    ...
    if (PXR_ENABLE_OPENVDB_SUPPORT)
        ...
        find_library(LIBZ "z")
        find_library(BLOSC "blosc")
        find_library(ILMMATH "Imath")
        find_library(BOOST_IOSTREAMS "boost_iostreams")
        set(OPENVDB_LIBRARY ${OPENVDB_LIBRARY} ${LIBZ} ${BLOSC} ${ILMMATH} ${BOOST_IOSTREAMS})
